...
##for t = 1:50
    ...
    [mu, sigma, observedLandmarks, landmarks_order, curr_lms] = correction_step(mu, sigma, data.timestep(t).sensor, observedLandmarks, landmarks_order);

    %Generate visualization plots of the current state of the filter
    plot_state(mu, sigma, landmarks, t, observedLandmarks, curr_lms, data.timestep(t).sensor, showGui);
