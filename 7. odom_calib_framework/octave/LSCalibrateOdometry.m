...
plot(
  odom_trajectory(:,1), odom_trajectory(:,2), "b;Uncalibrated Odometry;",
  scanmatch_trajectory(:,1), scanmatch_trajectory(:,2), "g;Scan-Matching;",
  calibrated_trajectory(:,1), calibrated_trajectory(:,2), "r;Calibrated Odometry;");
